# -*- coding: utf-8 -*-
"""p4_pregunta_02.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1h81wLYTMFU1WXFGIOHKaF2H5mxahzbtz
"""
...
for img_size in img_size_list:
    ...
    model = generar_red(num_classes, img_size, img_size, learning_rate)
...
ax1.plot(img_size_list, final_train_acc, marker='o', label='Train Accuracy', color='blue', linestyle='-')
ax1.plot(img_size_list, final_val_acc, marker='o', label='Test Accuracy', color='blue', linestyle='--')
ax1.plot(img_size_list, final_train_loss, marker='o', label='Train Loss', color='red', linestyle='-')
ax1.plot(img_size_list, final_val_loss, marker='o', label='Test Loss', color='red', linestyle='--')
ax1.tick_params(axis='y', labelcolor='blue')

# Ejes secundarios para tiempos de entrenamiento
ax2 = ax1.twinx()
ax2.set_ylabel('Tiempo (s)', color='green')
ax2.plot(img_size_list, time_list, marker='o', label='Training Time', color='green', linestyle='-')
...
plt.title('Impacto del Tamaño de Imagen en Métricas y Tiempo')
plt.show()